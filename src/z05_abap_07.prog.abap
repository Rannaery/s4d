...
AT SELECTION-SCREEN.
  TRY.
      booking_with_customer = zcl_05_helper=>get_booking_with_customer(
                                carrier_id    = carr_id
    ...
    CATCH zcx_no_booking_found INTO DATA(booking_exception).
      MESSAGE e000(z05_booking) WITH carr_id conn_id fl_date book_id.
    CATCH zcx_no_customer_found INTO DATA(customer_exception).
      MESSAGE e001(z05_booking) WITH booking_with_customer-customer_id.
  ENDTRY.
