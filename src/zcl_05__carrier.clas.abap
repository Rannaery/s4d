CLASS zcl_05__carrier DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    DATA airplanes TYPE z05_airplanes.

    METHODS constructor
      IMPORTING !name TYPE string.

    METHODS add_airplane
      IMPORTING airplane TYPE REF TO zcl_05_airplane.

    METHODS get_biggest_cargo_plane
      RETURNING VALUE(biggest_cargo_plane) TYPE REF TO zcl_05_cargo_plane.
...
CLASS zcl_05__carrier IMPLEMENTATION.
  METHOD add_airplane.
  ...
  METHOD get_biggest_cargo_plane.
    ...
    LOOP AT airplanes INTO DATA(airplane) WHERE table_line IS INSTANCE OF zcl_05_cargo_plane.
      DATA(cargo_plane) = CAST zcl_05_cargo_plane( airplane ).
